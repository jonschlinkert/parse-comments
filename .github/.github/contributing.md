# Contributing to parse-comments

First and foremost, thank you! We appreciate that you want to contribute to parse-comments, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for parse-comments**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for parse-comments:

- star the [project](https://github.com/jonschlinkert/parse-comments)
- tweet your support for parse-comments
...
- **version**: please note the version of parse-comments are you using
...
[so]: http://stackoverflow.com/questions/tagged/parse-comments
